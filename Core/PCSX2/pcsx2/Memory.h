...
#ifndef Alune_ENABLE_PSM_SAFE
#define Alune_ENABLE_PSM_SAFE 0
#endif
#ifndef DEBUG_ONLY_PSM_SAFE
#define DEBUG_ONLY_PSM_SAFE 0
#endif
#define P0_PSM_SAFE_ACTIVE ((Alune_ENABLE_PSM_SAFE == 1) && (DEBUG_ONLY_PSM_SAFE == 1))
...
static __fi void* PSM_Impl(u32 mem)
{
	if (!g_p0_psm_logged.exchange(true))
		LogUnified("@@P0_PSM_SAFE@@ active=%d dbg=%d\n", Alune_ENABLE_PSM_SAFE, DEBUG_ONLY_PSM_SAFE);
